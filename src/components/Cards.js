    ...
    <div>
      <div className="row featurette mx-4">
        ...
        <div className="col-md-5">
          <a href="todo.html">
            <img src={PersonalCardImg} alt="logo" className="img-fluid" />
          </a>
        </div>

        {/* <!-- 2nd card start hai --> */}

        <hr className="featurette-divider py-4 my-4" />
        ...
        <div className="col-md-5 order-md-1">
          <a href="todo.html">
            <img src={ProfessionalCardImg} alt="logo" className="img-fluid" />
          </a>
        </div>
      </div>
      {/* <!-- 2nd item start hai --> */}
      ...
      <div className="row featurette mx-4">
        ...
        <div className="col-md-5">
          <a href="todo.html">
            <img src={ShoppingCardImg} alt="logo" className="img-fluid" />
          </a>
        </div>
